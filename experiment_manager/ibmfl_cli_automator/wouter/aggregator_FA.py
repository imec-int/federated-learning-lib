...
class Aggregator(object):
    ...
    def __init__(self, **kwargs):
        ...
        py_config = cls_config.get('script')
        ...
        try:
            ...
            # TODO we'll hook up a function to get the python script info
            py_cls_reg = py_config.get('cls_ref')
            self.py_script = py_cls_reg(
                self.hyperparams, self.proto_handler, data_handler=self.data_handler)
            # here we'll link the fusion handler thingy
    ...
    def start_execution(self):
        """
        Start federated analytics execution. Request all the registered
        parties to initiate execution and return answers.
        ...
        try:
            ...
            logger.info('Finished Global FA execution')
        return True
